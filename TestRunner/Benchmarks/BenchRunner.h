...
public:
    ...
    void init(std::unique_ptr<llvm::Module> TheModule, std::unique_ptr<llvm::LLVMContext> Ctx)
    {
...
protected:
    double runIter(unsigned IterNum, unsigned Duration, llvm::function_ref<bool()> IterJob);
...
public:
    ...
    auto lookupFunc(llvm::StringRef Name) -> FuncTy*
    {
